...
- [中文文案排版指北](#中文文案排版指北)
  - [目录](#目录-1)
  - [空格](#空格-1)
    - [中英文之间需要增加空格](#中英文之间需要增加空格-1)
    - [中文与数字之间需要增加空格](#中文与数字之间需要增加空格-1)
    - [数字与单位之间无需增加空格](#数字与单位之间无需增加空格-1)
    - [全角标点与其他字符之间不加空格](#全角标点与其他字符之间不加空格-1)
    - [`-ms-text-autospace` to the rescue?](#-ms-text-autospace-to-the-rescue-1)
  - [标点符号](#标点符号-1)
    - [不重复使用标点符号](#不重复使用标点符号-1)
  - [全角和半角](#全角和半角-1)
    - [使用全角中文标点](#使用全角中文标点-1)
    - [数字使用半角字符](#数字使用半角字符-1)
    - [遇到完整的英文整句、特殊名词，其內容使用半角标点](#遇到完整的英文整句特殊名词其內容使用半角标点-1)
  - [名词](#名词-1)
    - [专有名词使用正确的大小写](#专有名词使用正确的大小写-1)
    - [不要使用不地道的缩写](#不要使用不地道的缩写-1)
  - [争议](#争议-1)
    - [链接之间增加空格](#链接之间增加空格-1)
    - [简体中文使用直角引号](#简体中文使用直角引号-1)
  - [工具](#工具-1)
  - [谁在这样做？](#谁在这样做-1)
  - [参考文献](#参考文献-1)
