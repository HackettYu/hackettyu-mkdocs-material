...
> GRID ALV 的单击事件的双击事件绑定的 CLASS 例子
> VIA: [https://github.com/mauriciolauffer/ABAP/blob/master/ALV/alv_grid_events.abap](https://github.com/mauriciolauffer/ABAP/blob/master/ALV/alv_grid_events.abap)
